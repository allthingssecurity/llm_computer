...
fn instruction_mood(instruction: Instruction) -> &'static str {
    match instruction {
        Instruction::AdjustStackPointer(_) => "the stack frame is resized backstage",
        Instruction::Load(_)
        | Instruction::LoadImmediate(_)
        | Instruction::LoadRelative(_)
        | Instruction::LoadPointer(_) => {
            "lifting values into the spotlight"
        }
        Instruction::Store(_) | Instruction::StoreRelative(_) | Instruction::StorePointer(_) => {
            "stitching a fresh write into memory"
        }
        Instruction::Swap(_) => "the cabinet spins, two values trading places",
        Instruction::Push | Instruction::Pop => "stack fabric folding through the frame",
        Instruction::AddImmediate(_)
        | Instruction::AddMemory(_)
        | Instruction::AddRelative(_)
        | Instruction::AddPointer(_)
        | Instruction::SubImmediate(_)
        | Instruction::SubMemory(_)
        | Instruction::SubRelative(_)
        | Instruction::SubPointer(_)
        | Instruction::MulImmediate(_)
        | Instruction::MulMemory(_)
        | Instruction::MulRelative(_)
        | Instruction::MulPointer(_) => "arithmetic tailored with sharp lines",
        ...
        | Instruction::CmpRelative(_)
        | Instruction::CmpPointer(_) => "logic panels snapping into place",
        ...
        | Instruction::JumpIfCarry(_)
        | Instruction::JumpIfNotCarry(_) => {
