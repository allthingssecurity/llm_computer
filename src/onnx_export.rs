...
fn map_memory_read(read: MemoryRead) -> OnnxInstructionRead {
    match read {
        ...
        MemoryRead::Indirect(address) => OnnxInstructionRead::Indirect { address },
        MemoryRead::Pointer(address) => OnnxInstructionRead::Pointer { address },
        MemoryRead::StackRelative(offset) => OnnxInstructionRead::StackRelative { offset },
