...
fn parse_instruction(
    ...
    let instruction = match pending.mnemonic.as_str() {
        ...
        "ADJSP" => Instruction::AdjustStackPointer(parse_i16_operand(line, operands)?),
        "LOADI" => Instruction::LoadImmediate(parse_i16_operand(line, operands)?),
        "LOAD" => Instruction::Load(parse_u8_operand(line, operands)?),
        "LOADR" => Instruction::LoadRelative(parse_u8_operand(line, operands)?),
        "LOADP" => Instruction::LoadPointer(parse_u8_operand(line, operands)?),
        "STORE" => Instruction::Store(parse_u8_operand(line, operands)?),
        "STORER" => Instruction::StoreRelative(parse_u8_operand(line, operands)?),
        "SWAP" => Instruction::Swap(parse_u8_operand(line, operands)?),
        "STOREP" => Instruction::StorePointer(parse_u8_operand(line, operands)?),
        ...
        "ADDR" => Instruction::AddRelative(parse_u8_operand(line, operands)?),
        "ADDP" => Instruction::AddPointer(parse_u8_operand(line, operands)?),
        "SUB" => Instruction::SubImmediate(parse_i16_operand(line, operands)?),
        "SUBM" => Instruction::SubMemory(parse_u8_operand(line, operands)?),
        "SUBR" => Instruction::SubRelative(parse_u8_operand(line, operands)?),
        "SUBP" => Instruction::SubPointer(parse_u8_operand(line, operands)?),
        "MUL" => Instruction::MulImmediate(parse_i16_operand(line, operands)?),
        "MULM" => Instruction::MulMemory(parse_u8_operand(line, operands)?),
        "MULR" => Instruction::MulRelative(parse_u8_operand(line, operands)?),
        "MULP" => Instruction::MulPointer(parse_u8_operand(line, operands)?),
        ...
        "CMPR" => Instruction::CmpRelative(parse_u8_operand(line, operands)?),
        "CMPP" => Instruction::CmpPointer(parse_u8_operand(line, operands)?),
        ...
        "JC" => Instruction::JumpIfCarry(parse_target(line, operands, labels)?),
        "JNC" => Instruction::JumpIfNotCarry(parse_target(line, operands, labels)?),
